// app/admin/editorial-board/page.tsx - WITH CONSISTENT PERMISSION CHECKS
...
import { AlertTriangle, PlusCircle, Users, UserCheck, Eye, ArrowLeft } from "lucide-react"
  ...
  try {
    ...
    return (
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                {canEditMembers && " and edit existing members"}
        ...
        {/* {(canCreateMembers || canEditMembers) && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-green-800 space-y-1">
                    ...
                    <li>• Designations and affiliations are current</li>
                    <li>• Order reflects the hierarchy and importance</li>
                    <li>• Contact information is verified</li>
                  </ul>
                </div>
              </div>
            </CardContent>
        ...
        {/* {!canEditMembers && !canCreateMembers && !canDeleteMembers && (
        ...
        {/* Permission Requirements Info for Denied Users */}
        {/* {!canCreateMembers && !canEditMembers && (
